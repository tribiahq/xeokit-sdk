 ...
 */
function generateTextureForColorsAndFlags (gl, colors, pickColors, vertexBases) {
 ...
 * @returns The created texture and its height
 */
function generateTextureForPositionsDecodeMatrices (gl, positionDecodeMatrices) {
 ...
 * TODO: document
 */
function generateTextureFor8BitIndices (gl, indices) {
    if (indices.length == 0) {
        return {
            texture: null,
            textureHeight: 0,
 ...
 * TODO: document
 */
function generateTextureFor16BitIndices (gl, indices) {
    if (indices.length == 0) {
        return {
            texture: null,
            textureHeight: 0,
 ...
 * TODO: document
 */
function generateTextureFor32BitIndices (gl, indices) {
    if (indices.length == 0) {
        return {
            texture: null,
            textureHeight: 0,
 ...
 * TODO: comment
 */
function generateTextureFor8BitsEdgeIndices (gl, edgeIndices) {
 ...
 * TODO: comment
 */
function generateTextureFor16BitsEdgeIndices (gl, edgeIndices) {
    if (edgeIndices.length == 0) {
        return {
            texture: null,
            textureHeight: 0,
 ...
 * TODO: comment
 */
function generateTextureFor32BitsEdgeIndices (gl, edgeIndices) {
    if (edgeIndices.length == 0) {
        return {
            texture: null,
            textureHeight: 0,
 ...
 * @returns The created texture and its height
 */
function generateTextureForPositions (gl, positions) {
...
/**
 */
function generateTextureForPackedPortionIds (gl, portionIdsArray) {
